...
const imageRequired = () => false;    // 画像添付は全種類で任意
const deadlineRequired = () => false; // 希望納期も全種類で任意
      ...
      <div style={{ maxWidth: 640, margin: "0 auto", padding: "28px 20px 80px" }}>
        ...
        {t && t !== "other" && (
          <Section title="生地・仕上げ・納期">
            ...
            <Field label="希望納期" hint="カレンダーから日付を選ぶか、時期が未定の場合は「特になし」を選んでください。">
              <TextInput type="date"
